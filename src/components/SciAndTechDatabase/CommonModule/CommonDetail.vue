	...
	<div>
		...
		<div class="RightSlideTit pl25 pr25 mt20 pa">
			...
			<table class="titTable per40 f14 mt5">
				...
				<tr>
					...
					<td>{{ companyOrgData?companyOrgData.regNature:'--' }} </td>
				</tr>
			</table>
		</div>
		<!--顶部工具栏 end-->
		...
		<div class="RightSlideBody pa">
			<Tabs @on-click="clickTabShow" :value="this.tabSign" type="card" :animated="false">
				<TabPane name="companyOrgSign" v-if="companyOrgData" label="工商数据" class="companyOrgBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#companyOrg01">工商信息</a>
						</li>
						<li class="fl">
							<a href="#companyOrg02">主要成员</a>
						</li>
						<li class="fl">
							<a href="#companyOrg03">企业概况</a>
						</li>
					</ul>
							...
							<table class="tableList" width="100%" cellpadding="5">
								<tbody v-if="companyOrgData">
									...
									<tr>
										...
										<td width="34%">{{ companyOrgData.companyCode? companyOrgData.companyCode:''}}</td>
										<td width="16%" class="f_9">公司类型</td>
										<td width="34%">{{ companyOrgData.regNature?companyOrgData.regNature:''}}</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="34%">{{ companyOrgData.regMoney?companyOrgData.regMoney:''}}</td>
				...
				<TabPane name="intelSign" v-if="intelSignData" label="知识产权" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#intelSign">年度专利数</a>
						</li>
						<li class="fl">
							<a href="#intelSign1">授权明细</a>
						</li>
						<li class="fl">
							<a href="#intelSign2">有效明细</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						<div id="intelSign" class="navPosiCon_items">
							<h3 class="navPosiCon_title pr"><p class="pa f16 fb">年度专利数</p><i class="pa"></i></h3>
							<p v-if="!intelSignData.intellectualApplyDto">暂无数据展示</p>

							<table width="100%" cellpadding="5" v-if="intelSignData.intellectualApplyDto" style="margin-bottom:30px;">
								<tbody>
									<tr>
										<td width="10%" rowspan="4" class="tit">申请专利数量</td>
										<td width="10%" rowspan="4">{{ intelSignData.intellectualApplyDto?intelSignData.intellectualApplyDto.total:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">发明</td>
										<td width="10%">{{ intelSignData.intellectualApplyDto?intelSignData.intellectualApplyDto.invent:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">实用新型 </td>
										<td width="10%">{{ intelSignData.intellectualApplyDto?intelSignData.intellectualApplyDto.utilityModel:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">外观设计 </td>
										<td width="10%">{{ intelSignData.intellectualApplyDto?intelSignData.intellectualApplyDto.design:''}}</td>
									</tr>
								</tbody>
							</table>
							<table width="100%" cellpadding="5" v-if="intelSignData.intellectualAuthorizeDto" style="margin-bottom:30px;">
								<p v-if="!intelSignData.intellectualAuthorizeDto">暂无数据展示</p>
								<tbody>
									<tr>
										<td width="10%" rowspan="4" class="tit">授权专利数量</td>
										<td width="10%" rowspan="4">{{ intelSignData.intellectualAuthorizeDto?intelSignData.intellectualAuthorizeDto.total:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">发明</td>
										<td width="10%">{{ intelSignData.intellectualAuthorizeDto?intelSignData.intellectualAuthorizeDto.invent:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">实用新型 </td>
										<td width="10%">{{ intelSignData.intellectualAuthorizeDto?intelSignData.intellectualAuthorizeDto.utilityModel:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">外观设计 </td>
										<td width="10%">{{ intelSignData.intellectualAuthorizeDto?intelSignData.intellectualAuthorizeDto.design:''}}</td>
									</tr>
								</tbody>
							</table>
							<table width="100%" cellpadding="5" v-if="intelSignData.intellectualEffectiveDto" style="margin-bottom:30px;">
								<tbody>
									<p v-if="!intelSignData.intellectualEffectiveDto">暂无数据展示</p>
									<tr>
										<td width="10%" rowspan="4" class="tit">有效专利数量</td>
										<td width="10%" rowspan="4">{{ intelSignData.intellectualEffectiveDto?intelSignData.intellectualEffectiveDto.total:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">发明</td>
										<td width="10%">{{ intelSignData.intellectualEffectiveDto?intelSignData.intellectualEffectiveDto.invent:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">实用新型 </td>
										<td width="10%">{{ intelSignData.intellectualEffectiveDto?intelSignData.intellectualEffectiveDto.utilityModel:''}}</td>
									</tr>
									<tr>
										<td width="10%" class="tit">外观设计 </td>
										<td width="10%">{{ intelSignData.intellectualEffectiveDto?intelSignData.intellectualEffectiveDto.design:''}}</td>
									</tr>
								</tbody>
							</table>
						</div>
						<div id="intelSign1" class="navPosiCon_items">
							...
							<p v-if="!intelSignData.authDetailDtos">暂无数据展示</p>
							<table style="margin-bottom:30px;" width="100%" cellpadding="5" v-if="intelSignData.authDetailDtos" :key="index" v-for="(item,index) in intelSignData.authDetailDtos">
								<tbody>
						...
						<div id="intelSign2" class="navPosiCon_items">
							...
							<p v-if="!intelSignData.validDetailDtos">暂无数据展示</p>
							<table style="margin-bottom:30px;" width="100%" cellpadding="5" v-if="intelSignData.validDetailDtos" :key="index" v-for="(item,index) in intelSignData.validDetailDtos">
								<tbody>
									<tr>
										<!-- <td width="84"  rowspan="4" colspan="1" class="tit">
                          {{index+1}}<br/>
				...
				<!-- 知识产权 -->
				<!-- 科技中小型企业 -->
				<TabPane name="techSmallCompSign" v-if="techSmallCompData" label="科技型中小企业" class="techSmallCompBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#EntpriItem01">企业概况</a>
						</li>
						<li class="fl">
							<a href="#EntpriItem02">负责人信息</a>
						</li>
						<li class="fl">
							<a href="#EntpriItem03">科研信息</a>
						</li>
						<li class="fl">
							<a href="#EntpriItem04">经营状况</a>
						</li>
						<li class="fl">
							<a href="#EntpriItem05">资金信息</a>
						</li>
						<li class="fl">
							<a href="#EntpriItem06">人员信息</a>
						</li>
						<li class="fl">
							<a href="#EntpriItem07">知识产权信息</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						<!--01-->
				...
				<!-- 科技中小型企业 -->
				<!-- 上市企业 -->
				<TabPane name="listedCompSign" v-if="listedCompData" label="上市企业" class="listedCompany">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#listedComp01">上市信息</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						<!--01-->
				...
				<!-- 上市企业 -->
				<!-- 新三板企业 -->
				<TabPane name="newThreeSign" v-if="newThreeData" label="新三板企业" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#newThree01">新三板信息</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						<!--01-->
				...
				<!-- 新三板企业 -->
				<!-- 新四板企业 -->
				<TabPane name="newFourSign" v-if="newFourData" label="新四板企业" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#newFour01">新四板信息</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						<!--01-->
				...
				<TabPane name="citySoarSign" v-if="citySoarSignData" label="市级高企" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#citySoarSign">市级高企</a>
						</li>
						<li class="fl">
							<a href="#citySoarSign1">负责人信息</a>
						</li>
						<li class="fl">
							<a href="#citySoarSign2">经营状况</a>
						</li>
						<li class="fl">
							<a href="#citySoarSign3">人员信息</a>
						</li>
						<li class="fl">
							<a href="#citySoarSign4">知识产权</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
				...
				<TabPane name="nationalHighSign" v-if="nationalHighSignData" label="国家级高企" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#nationalHighSign">企业概况</a>
						</li>
						<li class="fl">
							<a href="#nationalHighSign1">人员信息</a>
						</li>
						<li class="fl">
							<a href="#nationalHighSign2">经营概况</a>
						</li>
						<li class="fl">
							<a href="#nationalHighSign3">知识产权</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
				...
				<TabPane name="techniqueCenterSign" v-if="ComtechCenterData" label="企业技术中心" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#techniqueCenterSign">企业技术中心</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
				...
				<TabPane name="scienceCooperationSign" v-if="ScienceCooperationData" label="国际合作基地" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#scienceCooperationSign">国际合作基地</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
				...
				<TabPane name="academicianSign" v-if="academicianData" label="企业院士专家工作站" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#academicianSign">工作站信息</a>
						</li>
						<li class="fl">
							<a href="#academicianSign2">进站院士信息</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						...
						<div id="academicianSign2" class="navPosiCon_items">
							...
							<p v-if="!academicianExpertDtos">暂无数据展示</p>
							<table width="100%" cellpadding="5" v-if="academicianExpertDtos">
								<tbody>
									<!-- 企业院士专家工作站详情 -->
									...
									<tr>
										...
										<td width="25%">{{ academicianExpertDtos?academicianExpertDtos.expertName:''}}</td>
										<td width="10%" class="tit">院士学部</td>
										<td width="25%">{{ academicianExpertDtos?academicianExpertDtos.studyDept:''}}</td>
										<td width="10%" class="tit">当选时间</td>
										<td width="20%">{{ academicianExpertDtos?academicianExpertDtos.electionDate:''}}</td>
				...
				<TabPane name="GenPassServiceSign" v-if="GenPassServiceSignData" label="创通票服务机构" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#GenPassServiceSign">创通票服务机构</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
				...
				<!-- 创通票服务机构 -->
				<!-- 注册企业 -->
				<TabPane name="RegisterEnterpriseSign" v-if="RegisterEnterpriseSignData" label="创通票注册企业" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#RegisterEnterpriseSign">创通票注册企业</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
						<div id="RegisterEnterpriseSign" class="navPosiCon_items">
							<h3 class="navPosiCon_title pr"><p class="pa f16 fb">创通票注册企业</p><i class="pa"></i></h3>
				...
				<TabPane name="torchSign" v-if="torchSignData" label="火炬统计" class="newThreeBox">
					<ul class="clearfix navPosiTit">
						<li class="fl">
							<a href="#torchSign">企业概况</a>
						</li>
						<li class="fl">
							<a href="#torchSign1">经营概况</a>
						</li>
						<li class="fl">
							<a href="#torchSign2">人员概况</a>
						</li>
						<li class="fl">
							<a href="#torchSign3">科技活动人员情况</a>
						</li>
						<li class="fl">
							<a href="#torchSign4">科技活动费用情况</a>
						</li>
						<li class="fl">
							<a href="#torchSign5">企业办(境内)研发机构情况</a>
						</li>
						<li class="fl">
							<a href="#torchSign6">高新技术科技活动产出及相关情况</a>
						</li>
					</ul>
					<div class="navPosiCon scrollBar">
							...
							<table width="100%" cellpadding="5" v-if="torchSignData">
								<tbody>
									...
									<tr>
										...
										<td width="40%">{{ torchSignData.qyfrxb147?torchSignData.qyfrxb147:'无'}}</td>
									</tr>
									<tr>
										<td width="60%" class="tit">出生年份</td>
										<td width="40%">{{ torchSignData.csnf148 ?torchSignData.csnf148 +'年':'无'}}</td>
									</tr>
									<tr>
										<td width="60%" class="tit">学历</td>
										<td width="40%">{{ torchSignData.xl149?torchSignData.xl149:'无'}}</td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<!-- 雏鹰计划 -->
				<!-- 科技计划项目 -->
				<TabPane name="ProjectLibrarySign" v-if="ProjectLibrarySignData" label="科技计划项目" class="newThreeBox">
					<ul class="projectName clearfix">
						<li class="fl">
							<a style="width:130px;font-weight:bold;">企业申报项目：</a>
						</li>
						<li v-for="(item,index) in AllProjectData" :key="index" class="fl">
							<a @click="getProjectDetailsOne($event,item.id,index)" :title="item.projectName" :class="{active:num==index}">{{item.projectName}}</a>
						</li>
					...
					<div v-show="planType!=2">
						<ul class="clearfix navPosiTit" style="top:40px">
							<li class="fl">
								<a href="#ProjectLibrarySign">项目信息</a>
							</li>
							<li class="fl">
								<a href="#ProjectLibrarySign1">项目负责人信息</a>
							</li>
							<li class="fl">
								<a href="#ProjectLibrarySign2">项目经费信息</a>
							</li>
							<li class="fl">
								<a href="#ProjectLibrarySign3">项目组成员信息</a>
							</li>
						</ul>
								...
								<table width="100%" cellpadding="5" v-if="ProjectData" style="margin-bottom:30px;">
									<tbody>
										...
										<tr>
											...
											<td width="15%">{{ProjectData.headInformation?ProjectData.headInformation.companyCode:'无'}}</td>
										</tr>
										<tr>
					...
					<div v-show="planType==2">
						<ul class="clearfix navPosiTit" style="top:40px">
							<li class="fl">
								<a href="#ProjectLibrarySign4">项目信息</a>
							</li>
							<li class="fl">
								<a href="#ProjectLibrarySign5">企业信息</a>
							</li>
							<li class="fl">
								<a href="#ProjectLibrarySign6">人员信息</a>
							</li>
							<li class="fl">
								<a href="#ProjectLibrarySign7">营收缴税信息</a>
							</li>
						</ul>
						<div class="navPosiCon scrollBar" style="top:75px">
							<!-- 项目信息 -->
			...
			getCompanyOrgData() {
				...
				postAjax("/companyOrg/queryList", {
					...
					.then(response => {
						...
						this.areaInfoArea =
							response.data.obj.CompanyOrgDto[0].areaInfoProvice;
						this.NewThreeFourData = response.data.obj.CompanyTypeDto;
						this.industryCategoryDto = response.data.obj.industryCategoryDto;
						//            debugger
			...
			getacademicianData() {
				...
				postAjax("/compExpertWorkstation/queryList", {
					...
					.then(response => {
						...
						this.academicianExpertDtos = response.data.obj[0].academicianExpertDtos[0];
					})
					.catch(error => {
						console.log(error);
					});
			...
			geteyasPlanSignData() {
				...
				postAjax("/company/queryList", {
					...
					.then(response => {
						...
						this.zhishichanquanData =
							response.data.obj[0].projectinfo.zhishichanquan;
						this.xiangmulixiangData =
							response.data.obj[0].projectinfo.xiangmulixiang;
						this.rongziqingkuangData =
							response.data.obj[0].projectinfo.rongziqingkuang;
